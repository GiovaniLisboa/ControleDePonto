...
void calculo (struct usuario*); // cálculo total de horas
...
void impressao (struct usuario *user)
{
   ...
   /* if ((total_horas_mes % 60) < 10)
    ...
    {
        cout << "M" << (char)130 << "dia de horas trabalhadas por dia: " << ((media_horas) / 60) << "h0" << ((media_horas) % 60) << "min \n";
    }
    else cout << "M" << (char)130 << "dia de horas trabalhadas por dia: " << ((media_horas) / 60) << "h" << ((media_horas) % 60) << "min \n";
    
    if ((media_atrasos % 60) < 10)
    {
        cout << "M" << (char)130 << "dia de atraso por dia: " << ((media_atrasos) / 60) << "h0" << ((media_atrasos) % 60) << "min \n";
    }
    else cout << "M" << (char)130 << "dia de atraso por dia: " << ((media_atrasos) / 60) << "h" << ((media_atrasos) % 60) << "min \n";*/
}